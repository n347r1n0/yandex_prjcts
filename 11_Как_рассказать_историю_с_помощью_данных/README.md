...
GitHub не поддерживает визуализации, созданные с помощью библиотеки **Plotly**. Чтобы иметь возможность их отображения, воспользуйтесь [этой ссылкой](https://nbviewer.org/github/n347r1n0/yandex_prjcts/blob/main/11_Как_рассказать_историю_с_помощью_данных/Как_рассказать_историю_с_помощью_данных.ipynb) *(режим чтения сервиса nbviewer).*  

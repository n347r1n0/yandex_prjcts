...
> ᅠ В составе амбициозной команды сервиса «Ненужные вещи» мы выступаем в роли аналитика мобильных приложений. Нам доведётся поработать с различными видами аналитики: когортный анализ покажет, как поведение пользователей изменяется во времени, а сегментация позволит разделить пользователей на группы.<br><br>
>

...
Местами рекомендации кажутся оторванными от выводов.

Например, "Данные по открытию уведомлений позволяют точнее прогнозировать спрос." — хорошо, но рекомендация ("Использовать их для персонализированных push-уведомлений и email-рассылок.") звучит как совсем другой аспект. Может быть, переформулировать:
"Использовать данные о вероятности открытия уведомлений для предсказания спроса и более точного таргетинга акций."

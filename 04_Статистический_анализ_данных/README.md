...
> В качестве аналитика популярного сервиса аренды самокатов GoFast нам предстоит проанализировать предоставленные данные о пользователях сервиса GoFast и их поездках.
>
> Нами будут изучены различные аспекты поведения пользователей. На основе полученных результатов нам предстоит подтвердить или опровергнуть ряд гипотез, а также выдвинуть конкретные предложения по улучшению сервиса.
